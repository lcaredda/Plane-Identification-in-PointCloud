...
This repository contains the work I carried out during my Master's degree, focused on **plane identification in point clouds** using open-source LiDAR data from [IGN](https://www.ign.fr/).
